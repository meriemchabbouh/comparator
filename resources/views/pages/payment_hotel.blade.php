           ...
           <h1>Place your order</h1>
            <div class="bs-wizard">
              ...
              <div class="col-xs-4 bs-wizard-step disabled">
                  ...
                  <div class="progress"><div class="progress-bar"></div></div>
                  <a href="{{URL::asset('/confirmation_hotel')}}" class="bs-wizard-dot"></a>
                </div>  
	...
	<div class="row">
		<div class="col-md-8 add_bottom_15">
			...
			<div id="policy">
				...
				<a href="{{URL::asset('/confirmation_hotel')}}" class="btn_1 green medium">Book now</a>
			</div>
		</div>
		...
		<div class="box_style_1">
			...
			<a class="btn_full" href="{{URL::asset('/confirmation_hotel')}}">Book now</a>
