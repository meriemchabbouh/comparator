              ...
              <div class="strip_all_tour_list wow fadeIn" data-wow-delay="0.1s">
                <div class="row">
                    ...
                    <div class="wishlist">
                        ...
                        <div class="img_list"><a href="{{ route('get-car', $car->id) }}"><img src="{{ $car->getDefaultImage() }}" alt="Image">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                            ...
                            <h3><strong>{{ $car->id}}</strong> tour</h3>
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-2">
                        <div class="price_list">
                            <div><sup>$</sup>39*<span class="normal_price_list">$99</span><small >*Per person</small>
                                ...
                                <a class="btn_full" href="{{ route('get-edit-car', $car->id) }}">Modifier</a>
                                <a class="btn_map" href="{{ route('get-delete-car', $car->id) }}">Supprimer</a>
                            </div>
                        </div>
                    </div>
                </div>
