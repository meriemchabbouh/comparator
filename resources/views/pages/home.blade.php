                    ...
                    <div class="tab-content">
                        ...
                        <h3>Search Voitures in Tunisie</h3>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="ddslick" name="category">
                                            <option value="0" data-imagesrc="{{ asset('img/icons_search/all_tours.png') }}" selected>All tours</option>
                                            <option value="1" data-imagesrc="img/icons_search/sightseeing.png') }}">City sightseeing</option>
                                            <option value="2"  data-imagesrc="{{ asset('img/icons_search/museums.png') }}">Museum tours</option>
                                            <option value="3" data-imagesrc="{{ asset('img/icons_search/historic.png') }}">Historic Buildings</option>
                                            <option value="4" data-imagesrc="{{ asset('img/icons_search/walking.png') }}">Walking tours</option>
                                            <option value="5" data-imagesrc="{{ asset('img/icons_search/eat.png') }}">Eat & Drink</option>
                                            <option value="6" data-imagesrc="{{ asset('img/icons_search/churches.png') }}">Churces</option>
                                            <option value="7" data-imagesrc="{{ asset('img/icons_search/skyline.png') }}">Skyline tours</option>
                                        </select>
                                    </div>
                                </div>
                            </div><!-- End row -->
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label><i class="icon-calendar-7"></i> Date de retrait</label>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label><i class="icon-calendar-7"></i> Date de retour</label>
                                        <input class="date-pick form-control" data-date-format="M d, D" type="text">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="ddslick" name="category_2">
                                            <option value="0" data-imagesrc="{{ asset('img/icons_search/all_restaurants.png') }}" selected>All restaurants</option>
                                            <option value="1" data-imagesrc="{{ asset('img/icons_search/fast_food.png') }}">Fast food</option>
                                            <option value="2"  data-imagesrc="{{ asset('img/icons_search/pizza_italian.png') }}">Pizza / Italian</option>
                                            <option value="3" data-imagesrc="{{ asset('img/icons_search/international.png') }}">International</option>
                                            <option value="4" data-imagesrc="{{ asset('img/icons_search/japanese.png') }}">Japanese</option>
                                            <option value="5" data-imagesrc="{{ asset('img/icons_search/chinese.png') }}">Chinese</option>
                                            <option value="6" data-imagesrc="{{ asset('img/icons_search/bar.png') }}">Coffee Bar</option>
                                        </select>
                                    </div>
                                </div>
                            </div><!-- End row -->
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.1s">
                ...
                <div class="tour_container">
                    <div class="img_container">
                        ...
                        <img src="{{ asset('img/tour_box_1.jpg') }}" class="img-responsive" alt="Image">
            ...
            <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.2s">
                <div class="tour_container">
                    ...
                    <div class="img_container">
                        <a href="single_tour.html">
                        <img src="{{ asset('img/tour_box_2.jpg') }}" width="800" height="533" class="img-responsive" alt="Image">
            ...
            <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.3s">
                <div class="tour_container">
                    ...
                    <div class="img_container">
                        <a href="single_tour.html">
                        <img src="{{ asset('img/tour_box_3.jpg') }}" width="800" height="533" class="img-responsive" alt="Image">
                        <div class="badge_save">Save<strong>30%</strong></div>
                        <div class="short_info">
            ...
            <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.4s">
                <div class="tour_container">
                    ...
                    <div class="img_container">
                        <a href="single_tour.html">
                        <img src="{{ asset('img/tour_box_4.jpg') }}" width="800" height="533" class="img-responsive" alt="Image">
                        <div class="short_info">
            ...
            <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.5s">
                <div class="tour_container">
                    ...
                    <div class="img_container">
                        <a href="single_tour.html">
                        <img src="{{ asset('img/tour_box_14.jpg') }}" width="800" height="533" class="img-responsive" alt="Image">
                        <div class="short_info">
            ...
            <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.6s">
                <div class="tour_container">
                    ...
                    <div class="img_container">
                        <a href="single_tour.html">
                        <img src="{{ asset('img/tour_box_5.jpg') }}" width="800" height="533" class="img-responsive" alt="Image">
                        <div class="short_info">
            ...
            <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.7s">
                <div class="tour_container">
                    ...
                    <div class="img_container">
                        <a href="single_tour.html">
                        <img src="{{ asset('img/tour_box_8.jpg') }}" width="800" height="533" class="img-responsive" alt="Image">
                        <div class="short_info">
            ...
            <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.8s">
                <div class="tour_container">
                    ...
                    <div class="img_container">
                        <a href="single_tour.html">
                        <img src="{{ asset('img/tour_box_9.jpg') }}" width="800" height="533" class="img-responsive" alt="Image">
                        <div class="short_info">
            ...
            <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.9s">
                <div class="tour_container">
                    ...
                    <div class="img_container">
                        <a href="single_tour.html">
                        <img src="{{ asset('img/tour_box_12.jpg') }}" width="800" height="533" class="img-responsive" alt="Image">
                        <div class="short_info">
        ...
        <div class="container margin_60">
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6 text-center">
                    <p>
                        <a href="#"><img src="{{ asset('img/bus.jpg') }}" alt="Pic" class="img-responsive"></a>
                    </p>
                ...
                <div class="col-md-3 col-sm-6 text-center">
                    <p>
                        <a href="#"><img src="{{ asset('img/transfer.jpg') }}" alt="Pic" class="img-responsive"></a>
                    </p>
                ...
                <div class="col-md-3 col-sm-6 text-center">
                    <p>
                        <a href="#"><img src="{{ asset('img/guide.jpg') }}" alt="Pic" class="img-responsive"></a>
                    </p>
                ...
                <div class="col-md-3 col-sm-6 text-center">
                    <p>
                        <a href="#"><img src="{{ asset('img/hotel.jpg') }}" alt="Pic" class="img-responsive"></a>
                    </p>
    ...
    <div class="container margin_60">
        ...
        <div class="row">
            <div class="col-md-8 col-sm-6 hidden-xs">
                <img src="{{ asset('img/laptop.png') }}" alt="Laptop" class="img-responsive laptop">
            </div>
